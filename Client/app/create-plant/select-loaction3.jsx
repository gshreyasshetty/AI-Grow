...
export default function SearchPlant() {
  ...
  const { setPlant1Data } = useContext(CreateProContext);
        ...
        renderItem={({ item }) => (
          ...
          >
            <View style={styles.suggestionContent}>
              ...
              <Text style={styles.suggestionText}>{item.display_name || 'Unknown Location'}</Text>
            </View>
          </TouchableOpacity>
        )}
      />
